...
class ox(App):
        ...
        def esult(self,e):
                if self.b1.text=="X" and self.b2.text=="X" and self.b3.text=="X":
                  ...
                  e=e+1
                elif self.b1.text!="" and self.b2.text!="" and self.b3.text!="" and self.b4.text!="" and self.b5.text!="" and\
                  self.b6.text!="" and self.b7.text!="" and self.b8.text!="" and self.b9.text!="":
                  e=e+1
                else:
                  e=0
                return e
        def result(self):
              if self.b1.text=="X" and self.b2.text=="X" and self.b3.text=="X":
                ...
                self.b10.text="COM WIN"   
                 ...
                 self.b6.text!="" and self.b7.text!="" and self.b8.text!="" and self.b9.text!="":
                self.b10.text="TIE"
              if  self.b10.text=="TIE" or  self.b10.text=="COM WIN" or self.b10.text=="YOU WIN":
